...
namespace NLayer.Service.Services
{
    public class CategoryService : Service<Category>, ICategoryService
    {
        ...
        {
           var  categoryWithProductId= await _categoryRepository.GetSingleCategoryByIdWithProductAsync(categoryId);
          var categoryWithProductsDto =  _mapper.Map<CategoryWithProductsDto>(categoryWithProductId);
